...
public class DownloadUtility {
        ...
        private static final String TAG = DownloadUtility.class.getName();
        private static DownloadUtility downloadUtil;
        private final OkHttpClient okHttpClient;

        public static DownloadUtility get() {
            if (downloadUtil == null) {
                downloadUtil = new DownloadUtility();
            }
            return downloadUtil;
        }
